...
<section class="shop container" data-id="shop_cont">
    <section class="shop__filter filter">
        <div class = 'errors-box' style="color:red;">
            <p class="result-of-query"></p>
        </div>
        <form action="/helpers/helperContent.php" method="get" class='filter_form'>
            <div class="filter__wrapper">
                <b class="filter__title">Категории</b>
                <ul class="filter__list">
                <?php foreach ($categories as $category) : ?>
                    <li>
                        <a class="filter__list-item" href="/?filter=category_id<?= $category['id']; ?>"><?= $category['name']; ?></a>
                    </li>
                <?php endforeach; ?>
                </ul>
            </div>
...
<!-- Форма заказа -->
<section class="shop-page__order" hidden="" data-id="ord_cont">
            ...
            <fieldset class="custom-form__group">
                ...
                <div class="custom-form__column">
                    ...
                    <label class="custom-form__input-wrapper" for="third_name">
                        <input id="third_name" class="custom-form__input" type="text" name="third_name">
